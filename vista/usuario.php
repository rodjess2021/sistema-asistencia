...
<div class="page-content">
    ...
    <h4 class="text-secondary text-center">LISTA DE USUARIOS</h4>
    <?php
    include "../modelo/conexion.php";
    include "../controlador/modificarusuarioController.php";
    include "../controlador/eliminarusuarioController.php";
    $sql = $conexion->query(" SELECT * FROM usuario");
    ?>

    <div class="text-right">
        <a href="fpdf/reporteUsuario.php" target="_blank" class="btn btn-danger"><i class="fas fa-file-pdf"></i> Generar reporte PDF</a>
    </div>

    <a href="registro_usuario.php" class="btn btn-primary btn-rounded mb-2"><i class="fa-solid fa-plus"></i>&nbsp;Nuevo Usuario</a>
        ...
        <tbody>
            ...
            while ($datos = $sql->fetch_object()) { ?>
                <tr>
                    ...
                    <td><?= $datos->usuario ?></td>
                    <td>
                        <a href="" data-toggle="modal" data-target="#exampleModal<?= $datos->id_usuario ?>" class="btn btn-warning btn-sm"><i class="fa-solid fa-user-pen"></i></a>
