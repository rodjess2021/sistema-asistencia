<nav class="side-menu">
            ...
            <ul class="side-menu-list p-0">
                <li class="red">
                    <a href="inicio2.php" class="activo">
                        <img src="../public/img-inicio/programar.png" class="img-inicio" alt="">
                        <!-- <i class="fas fa-house-user"></i> -->
                        <span class="lbl">ASISTENCIA HOY   </span>
                    </a>
                </li>
                ...
                <li class="red">
                    <a href="usuario.php" class="activo">
                        <img src="../public/img-inicio/admins.png" class="img-inicio" alt="">
                        <!-- <i class="fas fa-house-user"></i> -->
                ...
                <li class="red">
                    <a href="asesor.php" class="activo">
                        <img src="../public/img-inicio/team.png" class="img-inicio" alt="">
                        <!-- <i class="fas fa-house-user"></i> -->
                        <span class="lbl">ASESORES   </span>
                    </a>
                </li>
