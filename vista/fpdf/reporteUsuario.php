...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(100, 10, utf8_decode("REPORTE DE USUARIOS ADMINISTRADORES "), 0, 1, 'C', 0);
      $this->Ln(7);
...
$pdf->Output('Reporte Usuario.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)