...
<div class="page-content">
    ...
    <div class="text-right">
        <a href="fpdf/reporteAsistencia.php" target="_blank" class="btn btn-danger mb-5"><i class="fas fa-file-pdf"></i> Exportar PDF</a>
    </div>
    ...
    <div class="text-right">
        <a href="fpdf/export_excel_hoy.php" class="btn btn-success mt-2 mb-2"><i class="fas fa-file-excel"></i> Exportar a Excel</a>
    </div>
...
<script>
    ...
    actualizarFechaHora(); // Inicializar con la fecha y hora actual
</script>